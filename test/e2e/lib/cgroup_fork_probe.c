 ...
 * parent then execs argv[1].
 *
 * This is intentionally x86_64 and libc-free: the sandbox E2E kernel and
 * Cloud Hypervisor artifacts are x86_64, and a tiny static binary keeps the
 * injected launch message well below proto.MaxMessageBytes.
 */
